...
int parseArgs(int argc, TCHAR** argv, TCHAR** port_number, TCHAR** server_address, TCHAR** output_dir_name)
{
    if (argc != 7)
    {
        help(argv[0]);
...
SOCKET constructConnection(TString port_number, TString server_address)
{
    char* srv_addr;
    char* port;
    WSADATA wsaData;
...
int dump_registers(TString dir)
{
